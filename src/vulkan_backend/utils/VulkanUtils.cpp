...
bool lumen::QueueFamilyIndices::isComplete() const
{
...
lumen::SwapChainSupportDetails lumen::utils::query_swapchain_support(VkPhysicalDevice device, VkSurfaceKHR surface)
{
...
bool lumen::utils::check_device_extension_support(VkPhysicalDevice device)
{
